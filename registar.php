...
<body>
    <div class="container">
        ...
        if (isset($_POST['registrar_libro'])) {
            ...
            // Verificar si los id_autor e id_editorial existen
            $autor_existente = $conex->query("SELECT id_autor FROM Autores WHERE id_autor = '$id_autor'");
            $editorial_existente = $conex->query("SELECT id_editorial FROM Editorial WHERE id_editorial = '$id_editorial'");

            if ($autor_existente->num_rows > 0 && $editorial_existente->num_rows > 0) {
                ...
                $mensaje = '<h3 class="message error">El autor o la editorial no existen en la base de datos.</h3>';
            }
        }
        ...
        <?php else: ?>
            ...
            <div class="form-container">
                ...
                <form method="post" action="">
                    ...
                    <input type="number" name="codigo_administrador" placeholder="Código Administrador" required>
